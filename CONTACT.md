...
**Provisioning requests are reviewed within 1–3 business days.**
...
Describe your use case (100–500 words):
...
- `node_pk.pem` — Public key (for verification)
...
A: 3–14 business days total, depending on tier and complexity.
...
5. **Wait for response** (1–3 business days)
